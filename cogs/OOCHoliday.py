...
channel = config['channels']['OOCHoliday']
highstaff = config['roles']['HighStaff']


class OOCHoliday(commands.Cog):
    def __init__(self, bot):
        self.bot = bot

    @commands.slash_command()
    async def ooc_отпуск(self, inter, дата_начала: str, дата_окончания: str, причина: str):
